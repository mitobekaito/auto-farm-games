...
function App() {
  ...
  // ページパスに応じて背景クラスを切り替える
  const bgClass = location.pathname.includes("/janken")
    ? "bg-janken"
    : location.pathname.includes("/omikuji")
    ? "bg-wagami"
    : "bg-gradient-to-br from-white to-sky-200";

  // 和風背景にしたいページのパス判定
  const isAppPage =
    location.pathname.includes("/janken") ||
    location.pathname.includes("/omikuji");
        ...
        <>
          ...
          <div className="absolute inset-0 z-0">
            ...
            <span
              ...
              style={{ top: "5%", left: "90%", animationDelay: "0.7s" }}
            />
            ...
            <span
              ...
              style={{ top: "12%", left: "95%", animationDelay: "1.9s" }}
            />
